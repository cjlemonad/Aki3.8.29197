...
class Mod {
    ...
    adjustItemProperties(dbItems) {
        for (const it in dbItems) {
            ...
            if (this.itemHelper.isOfBaseclass(dbItems[it]._id, BaseClasses_1.BaseClasses.KEY)) {
            ...
            if (config.all_keys_in_secure && this.itemHelper.isOfBaseclass(dbItems[it]._id, BaseClasses_1.BaseClasses.MOB_CONTAINER)) {
